...
import {
  IThreadControllerCreateThreadOutputError as IControllerError,
  IThreadControllerCreateThreadOutputSuccess as IControllerSuccess,
...
/**
 * @name					threadRouterCreateThread
 *
 * @description		The 'createThread' router for 'thread', whose expected
 *                inputs have been defined within the following schema:
 *                'threadValidationSchemaCreateThread'.
 *
...
export const threadRouterCreateThread = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'threadValidationSchemaCreateThread'.
      ...
      const stat = await threadController.createThread(validatedParams);
