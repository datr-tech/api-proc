...
import {
  IProcessControllerDeleteProcessOutputError as IControllerError,
  IProcessControllerDeleteProcessOutputSuccess as IControllerSuccess,
...
/**
 * @name					processRouterDeleteProcess
 *
 * @description		The 'deleteProcess' router for 'process', whose expected
 *                inputs have been defined within the following schema:
 *                'processValidationSchemaDeleteProcess'.
 *
 ...
 *                | Server error                | 500               |
 */
export const processRouterDeleteProcess = Router(options).delete(
  '/',
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'processValidationSchemaDeleteProcess'.
      ...
      const stat = await processController.deleteProcess(validatedParams);
