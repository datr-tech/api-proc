...
import {
  IProcessControllerCreateProcessOutputError as IControllerError,
  IProcessControllerCreateProcessOutputSuccess as IControllerSuccess,
...
/**
 * @name					processRouterCreateProcess
 *
 * @description		The 'createProcess' router for 'process', whose expected
 *                inputs have been defined within the following schema:
 *                'processValidationSchemaCreateProcess'.
 *
...
export const processRouterCreateProcess = Router(options).post(
  ...
  async (req: Request, res: Response) => {
    ...
    try {
       ...
       * defined within 'processValidationSchemaCreateProcess'.
      ...
      const stat = await processController.createProcess(validatedParams);
